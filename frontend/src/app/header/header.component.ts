...
export class HeaderComponent implements OnInit {
  ...
  // Passes a value back
  @Output() didLogIn = new EventEmitter<boolean>();

  @Output() didLogInNoValue = new EventEmitter();
  ...
  // Function declared to be used in Header.component.html

  setLogIn(value) {
    // this.isLoggedIn = !this.isLoggedIn;
    // console.log(this.isLoggedIn);
    this.didLogIn.emit(value);
  }

  setLogInNoValue() {
    console.log('NEW FUNCTION');
    this.didLogInNoValue.emit();
  }
